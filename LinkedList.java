public class LinkedList<E extends Comparable<E>> {
   ...
   * 
   * @param i The position of the element we're trying to get
   ...
   * 
   * @param value The value of the new node we're inserting
   * @param i The position in which we want to insert the new node
   ...
   * 
   * @param i Position of the element we want to remove
   */
